...
try {
    ...
    // ✅ 추천글 크롤링 테스트
    echo "<div class='section'>=== 추천글 크롤링 테스트 ===</div>\n";
    echo "<div class='info'>3-1. 추천글 크롤링 시작...</div>\n";
    $result1 = $crawler->crawlRecommendPosts(20); // 20개로 줄임
    echo "<div class='success'>추천글 완료: {$result1}개 저장</div>\n";
    ...
    echo "<div class='success'>추천글: {$result1}개</div>\n";
