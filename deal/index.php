...
var siteMapping = {
  ...
  if (item.thumbnail_url) {
    thumbnailHtml = '<img src="' + escapeHtml(item.thumbnail_url) + '" alt="상품 이미지" class="hotdeal-thumbnail" onerror="this.parentNode.innerHTML=\'<div class=&quot;no-thumbnail&quot;>이미지<br>없음</div>\'">';
  } else {
