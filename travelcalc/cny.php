...
<title>여행 환율 계산기 - 중국 위안(CNY) → 원화</title>
<meta name="description" content="중국 위안(CNY)을 원화로 환산하는 여행 환율 계산기. 실시간 환율 또는 고정환율을 선택할 수 있습니다.">
  ...
  <div class="card rate-card">
    ...
    <div class="rate-card-collapsible" id="rateCardCollapsible">
      ...
      <div class="fixed-rate-input-wrap" id="fixedRateWrap">
        <span id="fixedRateUnitLabel">1위안 =</span>
        <input type="text" inputmode="decimal" id="fixedRateInput" placeholder="예: 190">
        <span>원</span>
      </div>
    </div>
  </div>
      ...
      <div class="cur-box">
        <button type="button" class="cur-left cur-left-btn" id="curSelectBtn" aria-haspopup="true" aria-expanded="false">
          <div class="cur-left-info">
            ...
            <div class="cur-text">
              <div class="cur-name">중국</div>
              <div class="cur-code">CNY</div>
            </div>
          </div>
        ...
        <div class="cur-right">
          ...
          <div class="cur-sub" id="amountSub">0 위안</div>
        </div>
      </div>
...
<script>
  window.TRAVELCALC_CURRENCY = 'CNY';
</script>
