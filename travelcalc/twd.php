...
<title>여행 환율 계산기 - 대만 달러(TWD) → 원화</title>
<meta name="description" content="대만 달러(TWD)를 원화로 환산하는 여행 환율 계산기. 실시간 환율 또는 고정환율을 선택할 수 있습니다.">
  ...
  <div class="card rate-card">
    ...
    <div class="rate-card-collapsible" id="rateCardCollapsible">
      ...
      <div class="fixed-rate-input-wrap" id="fixedRateWrap">
        ...
        <input type="text" inputmode="decimal" id="fixedRateInput" placeholder="예: 43">
        <span>원</span>
      </div>
    </div>
  </div>
      ...
      <div class="cur-box">
        <button type="button" class="cur-left cur-left-btn" id="curSelectBtn" aria-haspopup="true" aria-expanded="false">
          <div class="cur-left-info">
            ...
            <div class="cur-text">
              <div class="cur-name">대만</div>
              <div class="cur-code">TWD</div>
            </div>
          </div>
...
<script>
  window.TRAVELCALC_CURRENCY = 'TWD';
</script>
