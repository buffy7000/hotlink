...
<title>여행 환율 계산기 - 뉴질랜드 달러(NZD) → 원화</title>
<meta name="description" content="뉴질랜드 달러(NZD)를 원화로 환산하는 여행 환율 계산기. 실시간 환율 또는 고정환율을 선택할 수 있습니다.">
...
<div class="wrap">
  ...
  <div class="card rate-card">
    ...
    <div class="rate-card-collapsible" id="rateCardCollapsible">
      ...
      <div class="fixed-rate-input-wrap" id="fixedRateWrap">
        <span id="fixedRateUnitLabel">1달러 =</span>
        <input type="text" inputmode="decimal" id="fixedRateInput" placeholder="예: 800">
        <span>원</span>
      </div>
    </div>
  </div>
  ...
  <div class="card converter-card">
      ...
      <div class="cur-box">
        <button type="button" class="cur-left cur-left-btn" id="curSelectBtn" aria-haspopup="true" aria-expanded="false">
          <div class="cur-left-info">
            ...
            <div class="cur-text">
              <div class="cur-name">뉴질랜드</div>
              <div class="cur-code">NZD</div>
            </div>
          </div>
        ...
        <div class="cur-right">
          ...
          <div class="cur-sub" id="amountSub">0 달러</div>
        </div>
      </div>
    ...
    <div class="quick-add-row">
      <button class="quick-add-btn" data-add="1">+1</button>
      <button class="quick-add-btn" data-add="5">+5</button>
...
<script>
  window.TRAVELCALC_CURRENCY = 'NZD';
</script>
