...
<title>여행 환율 계산기 - 유럽 유로(EUR) → 원화</title>
<meta name="description" content="유럽 유로(EUR)를 원화로 환산하는 여행 환율 계산기. 실시간 환율 또는 고정환율을 선택할 수 있습니다.">
  ...
  <div class="card rate-card">
    ...
    <div class="rate-card-collapsible" id="rateCardCollapsible">
      ...
      <div class="fixed-rate-input-wrap" id="fixedRateWrap">
        <span id="fixedRateUnitLabel">1유로 =</span>
        <input type="text" inputmode="decimal" id="fixedRateInput" placeholder="예: 1450">
        <span>원</span>
      </div>
    </div>
  </div>
      ...
      <div class="cur-box">
        <button type="button" class="cur-left cur-left-btn" id="curSelectBtn" aria-haspopup="true" aria-expanded="false">
          <div class="cur-left-info">
            ...
            <div class="cur-text">
              <div class="cur-name">유럽</div>
              <div class="cur-code">EUR</div>
            </div>
          </div>
        ...
        <div class="cur-right">
          ...
          <div class="cur-sub" id="amountSub">0 유로</div>
        </div>
      </div>
...
<script>
  window.TRAVELCALC_CURRENCY = 'EUR';
</script>
