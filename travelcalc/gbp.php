...
<title>여행 환율 계산기 - 영국 파운드(GBP) → 원화</title>
<meta name="description" content="영국 파운드(GBP)를 원화로 환산하는 여행 환율 계산기. 실시간 환율 또는 고정환율을 선택할 수 있습니다.">
  ...
  <div class="card rate-card">
    ...
    <div class="rate-card-collapsible" id="rateCardCollapsible">
      ...
      <div class="fixed-rate-input-wrap" id="fixedRateWrap">
        <span id="fixedRateUnitLabel">1파운드 =</span>
        <input type="text" inputmode="decimal" id="fixedRateInput" placeholder="예: 1700">
        <span>원</span>
      </div>
    </div>
  </div>
    ...
    <div class="exchange-row">
      <div class="cur-box">
        ...
        <div class="cur-right">
          ...
          <div class="cur-sub" id="amountSub">0 파운드</div>
        </div>
      </div>
...
<script>
  window.TRAVELCALC_CURRENCY = 'GBP';
</script>
