...
<title>여행 환율 계산기 - 미국 달러(USD) → 원화</title>
<meta name="description" content="미국 달러(USD)를 원화로 환산하는 여행 환율 계산기. 실시간 환율 또는 고정환율을 선택할 수 있습니다.">
  ...
  <div class="card rate-card">
    ...
    <div class="rate-card-collapsible" id="rateCardCollapsible">
      ...
      <div class="fixed-rate-input-wrap" id="fixedRateWrap">
        ...
        <input type="text" inputmode="decimal" id="fixedRateInput" placeholder="예: 1350">
        <span>원</span>
      </div>
    </div>
  </div>
...
<script>
  window.TRAVELCALC_CURRENCY = 'USD';
</script>
